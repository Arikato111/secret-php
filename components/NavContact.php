<div class="py-5 px-3 text-zinc-800 sm:fixed sm:overflow-x-auto max-h-[90vh] pb-5">
    ...
    <div class="px-5">
        <div class=" sm:block text-zinc-800">
            <a href="https://www.apple.com/app-store/" target="_blank" class="p-3 pw-full my-3 w-full bg-white focus:ring-4 focus:outline-none focus:ring-gray-300 shadow-md rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
            ...
            <a href="https://play.google.com/" target="_blank" class="p-3 w-full mb-3 bg-white shadow-md focus:ring-4 focus:outline-none focus:ring-gray-300 rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                <svg class="mr-3 w-7 h-7" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google-play" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <path fill="black" d="M325.3 234.3L104.6 13l280.8 161.2-60.1 60.1zM47 0C34 6.8 25.3 19.2 25.3 35.3v441.3c0 16.1 8.7 28.5 21.7 35.3l256.6-256L47 0zm425.2 225.6l-58.9-34.1-65.7 64.5 65.7 64.5 60.1-34.1c18-14.3 18-46.5-1.2-60.8zM104.6 499l280.8-161.2-60.1-60.1L104.6 499z"></path>
                </svg>
                <div class="text-left">
