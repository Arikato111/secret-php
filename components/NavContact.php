<div class="py-5 px-3">
    ...
    <div class="px-5">
        <div class=" items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
            <a href="#" class="p-3 pw-full my-3 w-full bg-white hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 shadow-md rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
            ...
            <a href="#" class="p-3 w-full sm:w-auto mb-3 bg-white shadow-md hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
